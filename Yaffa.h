...
/******************************************************************************/
#define STRING_SIZE   63        // Maximum size of a counted string, in
// characters
#define HOLD_SIZE     63        // Size of the pictured numeric output string 
// buffer, in characters
#define PAD_SIZE      63        // Size of the scratch area pointed to by PAD,
// in characters
#define FLOORED       TRUE      // Floored Division is default
#define ADDRESS_BITS  32        // Size of one address unit, in bits
#define MAX_CHAR      0x7E      // Max. value of any character
#define MAX_D         2^31-1    // Largest usable signed double number
#define MAX_N         2^31-1    // largest usable signed integer
#define MAX_U         2^32-1    // largest usable unsigned integer
#define MAX_UD        2^32-1    // Largest usable unsigned double number
#define RSTACK_SIZE   24        // Max. size of the return stack, in cells
#define STACK_SIZE    24        // Max. size of the data stack, in cells

#define BUFFER_SIZE   128       // Min. size is 80 characters for ANS Forth
#define TOKEN_SIZE    64        // Definitions names shall contain 1 to 63 char.
#define FORTH_SIZE    5300      // Size of Forth Space in cells
